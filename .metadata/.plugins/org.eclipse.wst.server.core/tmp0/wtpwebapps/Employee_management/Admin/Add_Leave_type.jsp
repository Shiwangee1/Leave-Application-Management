	...
	<jsp:include page="/Admin/include.jsp" />
		...
		<div class="container col-lg-9 bg-light mt-4">
			...
			<div class="card-body">
				<nav class="navbar navbar-light bg-light">
					<div class="container-fluid">
						<a class="navbar-brand" href="#"><h4>Leave Section</h4></a> <a
							class="navbar-brand" href="#">Manage type/add</a>
			...
			<form action="../Add_Leave_type" method="Post">
				<div class="mb-3">
				<div id="emailHelp" class="form-text">please fill up the form in order to add new Leave type 
						</div> 
					<label for="department_name" class="form-label">Leave Type
						</label> <input type="text" class="form-control"
						 aria-describedby="departmenmtHelp" name="leave_type" required>
					
				</div>
				<div class="mb-3">
					<label for="Shortform" class="form-label">Short Description</label>
					<input type="test" class="form-control"
						 name="shortform_discription" required>
				</div>
