		...
		<div class="container col-lg-9 bg-light mt-8">
			...
			<div class="card-body">
				<nav class="navbar navbar-light bg-light">
					<div class="container-fluid">
						<a class="navbar-brand" href="Add_Departments"><h4>Manage Admin
								Section</h4></a> <a class="navbar-brand" href="Leave_type">Manage Admin/Admin
							Page</a>
			...
			<div class="container">
				<div class="text-center mt-3 mb-3">
					<a href="Add_ManageAdmin.jsp" class="btn btn-primary ">Add
						Admin</a>
				...
				<table class="table">
					<thead>
						...
						<tr>
							...
							<td><%=rs.getString("AccountCreatedOn")%></td>
							<td>
								<form action="../ManageAdminDelete" method="post">
								...
								href="Edit_ManageAdmin.jsp?id=<%=rs.getString("id")%>"
