			...
			<div class="card-body">
				<nav class="navbar navbar-light bg-light">
					<div class="container-fluid">
						<a class="navbar-brand" href="Add_Departments"><h4>Approved
								Leave</h4></a> <a class="navbar-brand" href="Leave_type">Home/Approved
							List Page</a>
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					try {
						...
						+ "JOIN apply_leave ON add_employee.id = apply_leave.id " + "WHERE apply_leave.Apply_Status = 'decline'";
